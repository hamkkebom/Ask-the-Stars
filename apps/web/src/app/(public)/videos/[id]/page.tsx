...
const mockVideo = {
  ...
  thumbnailUrl:
    'https://images.unsplash.com/photo-1515523110800-941516ebcd43?auto=format&fit=crop&q=80&w=1000',
  views: 15420,
  likes: 892,
  createdAt: '2026.01.15',
  duration: '12:30',
  description:
    '2026년 을사년(푸른 뱀의 해)은 지혜와 재물을 상징합니다. 특히 상반기보다 하반기에 주목해야 할 띠별 운세를 상세하게 풀어드립니다. 사주 전문가 김태희 상담사가 알려드리는 행운의 비밀을 놓치지 마세요!',
  categories: ['신년운세', '사주'],
...
const creatorVideos: VideoProps[] = [
  {
    id: 'cv1',
    title: '황금 돼지띠 2월 운세 총정리',
    thumbnailUrl:
      'https://images.unsplash.com/photo-1549480662-8f6a9e2d3d92?auto=format&fit=crop&q=80&w=500',
    category: '월별운세',
    tags: ['돼지띠'],
    counselor: { name: '김태희' },
    creator: { name: '박건우' },
  ...
  {
    id: 'cv2',
    title: '손금으로 보는 나의 말년운',
    thumbnailUrl:
      'https://images.unsplash.com/photo-1581023719881-acef076b9071?auto=format&fit=crop&q=80&w=500',
    category: '관상',
    tags: ['손금'],
    counselor: { name: '김태희' },
    creator: { name: '박건우' },
...
const categoryVideos: VideoProps[] = [
  {
    id: 'rv1',
    title: '타로로 보는 이번 달 연애운',
    thumbnailUrl:
      'https://images.unsplash.com/photo-1620065463208-c87aecb39130?auto=format&fit=crop&q=80&w=500',
    category: '타로',
    tags: ['연애운'],
    counselor: { name: '지니' },
    creator: { name: '김PD' },
  ...
  },
  {
    ...
    title: '꿈해몽: 이빨 빠지는 꿈',
    thumbnailUrl:
      'https://images.unsplash.com/photo-1445462657202-a0893228a1e1?auto=format&fit=crop&q=80&w=500',
    category: '해몽',
    tags: ['흉몽'],
    counselor: { name: '천명' },
    creator: { name: '이감독' },
  ...
  },
  {
    ...
    title: '나에게 맞는 수호신 찾기',
    thumbnailUrl:
      'https://images.unsplash.com/photo-1599703498064-0775d7857193?auto=format&fit=crop&q=80&w=500',
    category: '신점',
    tags: ['수호신'],
    counselor: { name: '무무' },
    creator: { name: '박PD' },
  ...
  },
  {
    ...
    title: '돈이 들어오는 지갑 풍수',
    thumbnailUrl:
      'https://images.unsplash.com/photo-1620786595460-64585f57fc1a?auto=format&fit=crop&q=80&w=500',
    category: '풍수',
    tags: ['재물운'],
    counselor: { name: '청담' },
    creator: { name: '김제작' },
...
const comments = [
  {
    id: 1,
    user: '별님123',
    content: '정말 소름돋네요... 지난달에 말씀하신 거 다 맞았어요 ㄷㄷ',
    date: '2시간 전',
    likes: 24,
    profileUrl: 'https://api.dicebear.com/7.x/adventurer/svg?seed=Felix',
  },
  {
    id: 2,
    user: '행운가득',
    content: '목소리가 너무 편안해서 끝까지 다 봤습니다. 감사합니다!',
    date: '5시간 전',
    likes: 12,
    profileUrl: 'https://api.dicebear.com/7.x/adventurer/svg?seed=Aneka',
  },
  {
    id: 3,
    user: '미래지향',
    content: '내년 하반기 기대되네요! 화이팅!',
    date: '1일 전',
    likes: 5,
    profileUrl: 'https://api.dicebear.com/7.x/adventurer/svg?seed=Precious',
  },
];
...
export default async function VideoDetailPage({
  ...
  try {
    ...
    const r2Url =
      techSpec.technicalSpec?.videoUrl || getVideoSrc(techSpec.technicalSpec);
