            ...
            >
              ...
              <div className="flex-1">
                <h4 className="font-medium text-gray-900 line-clamp-1">
                  {video.versionTitle || video.project?.title || '제목 없음'}
                </h4>
              ...
              {/* Action */}
              <Link
                href={`/stars/my-projects/detail/${video.assignmentId || video.projectId}`}
                className="ml-4 px-3 py-1 text-sm border rounded hover:bg-gray-100 text-gray-600"
              >
                상세
              </Link>
            </div>
