# 함께봄-스타(Hamkkebom-Star) 엔지니어링 표준 및 코드 패턴

이 문서는 함께봄-스타 프로젝트의 공식 코딩 표준을 정의합니다. `agent-skills-main` 저장소와 Vercel의 권장 사항을 기반으로 작성되었습니다. **AI 에이전트와 개발자는 반드시 이 패턴을 준수해야 합니다.**
