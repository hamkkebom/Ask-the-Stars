      ...
      content: (
        <>
          <p className="m-0 mb-4">
            한깨봄(이하 &quot;회사&quot;)은 다음의 목적을 위하여 개인정보를 수집
            및 이용합니다:
          </p>
          <ul className="list-disc pl-5 space-y-2 m-0">
            <li>
              <strong>회원 관리</strong>: 회원제 서비스 이용, 개인 식별, 가입
              의사 확인, 본인 확인
            </li>
            <li>
              <strong>서비스 제공</strong>: 영상 제작 협업 서비스,
              프리랜서-클라이언트 매칭, 정산 서비스
            </li>
            <li>
            ...
            <li>
              <strong>서비스 개선</strong>: 접속 빈도 파악, 서비스 이용 통계
            </li>
          </ul>
        </>
      ),
      ...
      content: (
        <>
          <p className="m-0 mb-4">
            ...
            정보를 지체 없이 파기합니다. 단, 관련 법령에 의해 보존할 필요가 있는
            경우 아래와 같이 보관합니다:
          </p>
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <ul className="list-disc pl-5 space-y-2 m-0">
            <li>
              <strong>관리적 조치</strong>: 개인정보 보호 담당자 지정, 취급
              직원의 교육
            </li>
            <li>
              <strong>기술적 조치</strong>: 개인정보 암호화, 접근 제어 시스템
              운영, 보안 프로그램 설치
            </li>
            <li>
      ...
      content: (
        <>
          ...
          <p className="mt-4 m-0">
            권리 행사는 서면, 전자우편 등을 통해 하실 수 있으며, 회사는 이에
            대해 지체 없이 조치하겠습니다.
          </p>
        </>
      ),
      ...
      content: (
        <>
          <p className="m-0 mb-4">
            ...
            불필요하게 된 때에는 지체 없이 해당 개인정보를 파기합니다.
          </p>
          <ul className="list-disc pl-5 space-y-2 m-0">
            <li>
            ...
            <li>
              <strong>종이 문서 형태</strong>: 분쇄 또는 소각
            </li>
          </ul>
        </>
      ),
      ...
      content: (
        <>
          <p className="m-0 mb-4">
            ...
            처리 및 피해 구제 등을 위하여 아래와 같이 개인정보 보호 책임자를
            지정하고 있습니다.
          </p>
