...
| **Resend** | 트랜잭션 이메일 발송 (가입 환영, 알림) | **Free Plan**<br>- 월 3,000건 무료<br>- 일일 100건 제한 | [Resend Dashboard](https://resend.com/overview) | 도메인: `hankaebom.com` |
...
- [ ] **도메인 (hankaebom.com)**: 매년 갱신 필요 (구매처 확인 필요)
