...
const requestSchema = z.object({
  ...
  categories: z
    .string()
    .min(1, '카테고리를 1개 이상 입력해주세요 (쉼표로 구분)'),
...
export default function CreateRequestPage() {
  ...
  const inputClass =
    'w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all';
