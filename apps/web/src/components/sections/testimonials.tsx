        ...
        <div className="relative">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="bg-white rounded-3xl p-10 md:p-14 shadow-xl"
            >
              <Quote className="w-12 h-12 text-[#FF3366]/20 mb-6" />
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                <div className="flex items-center gap-4">
                  <div className="w-14 h-14 rounded-full bg-gradient-to-br from-[#FF3366] to-[#FF6B9D] flex items-center justify-center text-white font-bold text-xl">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="px-4 py-2 bg-[#FF3366]/10 text-[#FF3366] font-bold rounded-full text-sm">
          ...
          <div className="flex justify-center gap-4 mt-8">
            <button
              onClick={prev}
              className="w-12 h-12 rounded-full border-2 border-gray-200 flex items-center justify-center hover:border-[#FF3366] hover:text-[#FF3366] transition-colors"
            >
              ...
              {testimonials.map((_, idx) => (
                <button
                  ...
                  className={`w-2.5 h-2.5 rounded-full transition-all ${
                    idx === current ? 'bg-[#FF3366] w-8' : 'bg-gray-300'
                  }`}
                />
              ))}
            </div>
