...
export const mockPortfolioItems: PortfolioItem[] = [
  {
    ...
    tags: ['브이로그', '맛집', '여행'],
    description:
      '서울 강남의 숨겨진 맛집을 찾아다니는 브이로그 영상입니다. 빠른 컷 편집과 리듬감 있는 자막을 활용했습니다.',
    role: '편집, 자막',
    stats: {
      views: 12500,
      likes: 850,
  ...
  },
  {
    ...
    tags: ['운동', '자기관리', '숏폼'],
    description:
      '인스타그램 릴스와 틱톡을 타겟으로 한 빠른 템포의 운동 챌린지 영상입니다.',
    role: '전체 제작',
    stats: {
      views: 45000,
      likes: 3200,
  ...
  },
  {
    ...
    tags: ['디자인', '마케팅', '제품'],
    description:
      'IT 기기 신제품 런칭 유튜브 영상의 클릭률을 높이기 위한 고화질 썸네일 디자인입니다.',
    role: '디자인',
  ...
  },
  {
    ...
    tags: ['게임', '하이라이트', '이펙트'],
    description:
      '화려한 이펙트와 사운드 효과를 강조한 FPS 게임 하이라이트 영상입니다.',
    role: '편집, 효과',
    stats: {
      views: 8900,
      likes: 420,
  ...
  },
  {
    ...
    tags: ['시네마틱', '카페', '감성'],
    description:
      '색보정(Color Grading)에 중점을 둔 감성적인 카페 홍보 영상입니다.',
    role: '촬영, 편집, 색보정',
    stats: {
      views: 3400,
      likes: 150,
  ...
  },
  {
    ...
    tags: ['반려동물', '귀여움', '바이럴'],
    description:
      '강아지의 귀여운 순간을 포착하여 음악에 맞춰 편집한 바이럴 영상입니다.',
    role: '전체 제작',
    stats: {
      views: 120000,
      likes: 15000,
