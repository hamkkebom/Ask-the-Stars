...
const recentTransactions = [
  {
    id: '1',
    type: 'income',
    description: '교육 수강료 - AI 영상 제작 기초',
    amount: 150000,
    date: '2026-01-18',
  },
  {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <GlassCard className="p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center text-green-400 text-sm">
              <ArrowUpRight className="w-4 h-4" />+{financeStats.revenueChange}%
            </div>
          </div>
        ...
        <GlassCard className="p-6">
          ...
          <p className="text-3xl font-bold text-orange-400">
            {formatCurrency(financeStats.pendingPayouts)}
          </p>
        </GlassCard>
        ...
        <GlassCard className="p-6">
          ...
          <p className="text-3xl font-bold text-green-400">
            {formatCurrency(financeStats.completedPayouts)}
          </p>
        </GlassCard>
        ...
        <GlassCard className="p-6">
          ...
          <p className="text-3xl font-bold text-red-400">
            {formatCurrency(financeStats.monthlyExpense)}
          </p>
        </GlassCard>
      </div>
