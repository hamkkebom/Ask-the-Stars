...
| 문서 | 설명 |
|---|---|
| [QUICK_START.md](./01-getting-started/QUICK_START.md) | 빠른 시작 가이드 |
...
| 문서 | 설명 |
|---|---|
| [0001-tech-stack-selection.md](./08-adr/0001-tech-stack-selection.md) | 기술 스택 선정 |
